/* viewing-look-3.c uses the idle callback to animate the keyboard-controlled */
/* motion of the cube viewer.                                                 */
...
{                                                                              \
    GLdouble M[16];                                                            \
                                                                               \
    GLdouble dt = 1.0 / 10.0;                                                  \
    GLdouble kx = keyboard_dx * dt;                                            \
    GLdouble ky = keyboard_dy * dt;                                            \
    GLdouble kz = keyboard_dz * dt;                                            \
                                                                               \
